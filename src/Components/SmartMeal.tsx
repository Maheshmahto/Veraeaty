...
import { ChefHat, Sparkles, Zap, CircuitBoard, Heart } from "lucide-react";
  ...
  return (
    <div className="min-h-screen  relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-10 w-50 h-70 rounded-full mix-blend-multiply filter blur-3xl opacity-15 animate-float bg-[#EA785B]"></div>
        <div className="absolute top-60 right-20 w-60 h-70 rounded-full mix-blend-multiply filter blur-3xl opacity-15 animate-float-delayed bg-[#FF9B7D]"></div>
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* <div className="absolute top-1/2 left-0 w-full h-px opacity-15 animate-pulse-slower bg-gradient-to-r from-transparent via-[#FF9B7D] to-transparent"></div> */}
        {/* <div
        ...
        <div className="w-full">
          ...
          <div className="text-center mb-16">
            <div className="relative mb-12 flex justify-center">
              <div className="backdrop-blur-2xl bg-white/60 max-w-6xl rounded-3xl p-12 md:p-16 border border-white/60 relative overflow-hidden shadow-2xl shadow-orange-500/15 mx-auto">
                ...
                <div className="relative flex items-center justify-center gap-8 mb-8">
                  <div className="relative">
                    <div className="w-20 h-20 md:w-24 md:h-24 rounded-2xl backdrop-blur-xl bg-white/80 border border-white/60 flex items-center justify-center shadow-lg animate-float shadow-orange-500/20">
                      <CircuitBoard className="w-10 h-10 md:w-12 md:h-12 text-[#EA785B]" />
                    </div>
                    <div
                  ...
                  <div className="relative">
                    <div className="w-28 h-28 md:w-32 md:h-32 rounded-3xl backdrop-blur-xl bg-gradient-to-br from-white/90 to-white/70 border-2 border-white/80 flex items-center justify-center shadow-2xl shadow-orange-500/40">
                      <ChefHat className="w-14 h-14 md:w-16 md:h-16 text-[#EA785B]" />
                      <div
                        className="absolute inset-0 rounded-3xl animate-ping border-2 border-[#EA785B] opacity-20"
                        style={{ animationDuration: "3s" }}
                      ></div>
                    </div>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <div
                      ...
                      style={{ animationDelay: "1s" }}
                    >
                      <Sparkles className="w-10 h-10 md:w-12 md:h-12 text-[#FF9B7D]" />
                    </div>
                  </div>
                </div>
                ...
                <div
                  ...
                  style={{ animationDelay: "0.5s" }}
                >
                  <Zap className="w-6 h-6 text-[#EA785B]" />
                </div>
                <div
                ...
                >
                  <Heart className="w-6 h-6 text-[#FF9B7D]" />
                </div>

                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-gradient-to-br from-[#EA785B] to-[#FF9B7D] bg-clip-text text-transparent text-center">
            ...
            <div className="backdrop-blur-xl mt-20   max-w-2xl mx-auto ">
              {!submitted ? (
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="relative">
                    {/* <h1>Join the Veraeaty Revolution</h1> */}
                    <h1 className="text-4xl md:text-5xl lg:text-5xl font-semibold mb-10 text-black bg-clip-text text-center">
                      Join the <span className="text-[#E16D4F]">Veraeaty</span>{" "}
                      Revolution
                    </h1>
                    <input
                      type="email"
                      ...
                      required
                      className="w-full px-5 py-4 rounded-4xl bg-white/90 backdrop-blur-sm border-2 border-gray-200/60 focus:outline-none focus:ring-4 focus:ring-orange-500/10 focus:border-[#EA785B] transition-all duration-300 text-gray-900 placeholder-gray-400 text-lg shadow-sm"
                    />
                  </div>
                  <button
                    type="submit"
                    disabled={isSubmitting}
                    className="w-full px-5 py-4 rounded-4xl text-white font-semibold text-lg shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed bg-gradient-to-br from-[#EA785B] to-[#FF9B7D] shadow-orange-500/40 hover:shadow-orange-500/50"
                  >
                    {isSubmitting ? (
                ...
                <div className="text-center py-8 animate-fade-in">
                  <div className="inline-flex items-center justify-center w-20 h-20 rounded-full mb-6 shadow-lg bg-gradient-to-br from-green-500 to-green-600 shadow-green-500/40">
